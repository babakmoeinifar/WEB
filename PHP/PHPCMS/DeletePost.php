...
if (isset($_POST["Submit"])) {
    ...
    //Success Messages
    if ($execute) {
        $_SESSION["SuccessMessage"] = 'Post Removed Successfully';
        redirectTo("dashboard.php");
    } else {
        $_SESSION["ErrorMessage"] = 'Post failed to Remove';
        redirectTo("dashboard.php");
    }
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div><!--  -->
                ...
                <form class="form-group" action="DeletePost.php?Delete=<?php echo $searchQueryParameter; ?>"
                      method="POST"
                    ...
                    <fieldset>
                        ...
                        <label class="form-label d-none" for="imageselect"><span
                                    class='text-info'>Select image:</span></label>
                        <input class="form-control btn d-none" type="file" name="Image" id="imageselect">
                        <!--Post Update -->
                        <label class="form-label pt-3" for="postarea"><span class="text-info">Post:</span></label>
                        <textarea name="Post" id="postarea" class="form-control" disabled>
                            <?php echo $postToUpdate; ?>
                        </textarea>
                        <!-- Update Post btn -->
                        <br><input class="btn btn-danger btn-block" type="Submit" name="Submit"
                                   value="Delete Post"><br>
                    </fieldset>
                </form>
            </div>
