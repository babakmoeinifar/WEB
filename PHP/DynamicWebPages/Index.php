    ...
    <div id="main">
        <div id="content">
            ...
            if(!empty($_GET['PageName'])){
                ...
                //print_r($pagesFolder);
                //print_r -> Array ( [0] => . [1] => .. [2] => About.inc.php [3] => Contact.inc.php [4] => Home.inc.php [5] => ShareWithFriend.inc.php )
                //Because of ([0] => . [1] => ..) we have to unset them. we don't want [0] and [1]
                unset($pagesFolder[0],$pagesFolder[1]);
                //After unset -> Array ( [2] => About.inc.php [3] => Contact.inc.php [4] => Home.inc.php [5] => ShareWithFriend.inc.php )
                //print_r($pagesFolder);
                $PageName = $_GET['PageName'];
                //for example if about.inc.php in $pagesFolder is exists
                if (in_array($PageName.'.inc.php',$pagesFolder)){
                    //open page about.inc.php
                    include ($pagesDirectory.'/'.$PageName.'.inc.php');
                }
                else{
                    echo '<h1 id="request">You are lost</h1>';
                    echo '<img src="images\lost.gif" width="660" height="430">';
                    echo '<h2>Page not found</h2>';
                }

            }
            //default home page opens
            else{
